...
const CardView = () => {
    ...
    useEffect(() => {
        const fetchCardData = async () => {
            setLoading(true);
            try {
                const response = await fetch(`https://www.ptcglegends.com/api/cards/${set}/${number}`);
                if (response.ok) {
    ...
    useEffect(() => {
        ...
        const fetchOtherVersions = async () => {
            try {
                const response = await fetch(`https://www.ptcglegends.com/api/cards/searchbyname/${encodeURIComponent(cardInfo.name)}`);
                if (response.ok) {
    ...
    useEffect(() => {
        ...
        const fetchEventIds = async () => {
            try {
                const response = await fetch('https://www.ptcglegends.com/event-ids');
                if (response.ok) {
                    const data = await response.json();
                    return data;
                } else {
        ...
        const fetchEventData = async (eventId) => {
            try {
                const response = await fetch(`https://www.ptcglegends.com/events/${eventId}`);
                if (response.ok) {
                    const data = await response.json();
                    return data;
                } else {
